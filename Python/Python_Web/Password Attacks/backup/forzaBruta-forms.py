...
def usage():
    ...
    print "		-c: hide a specific response with the given size chars"
    print "example: forzaBruta-forms.py -w http://www.targetsite.com/check_login.php -t 5 -f pass.txt -p \"username=admin&password=FUZZ\"\n"
